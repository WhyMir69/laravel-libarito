                ...
                <form action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            @if($product->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" width="100" height="100" class="rounded">
                            ...
                            @error('image')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <small class="text-muted">Leave empty to keep current image. Allowed formats: JPEG, PNG, JPG, GIF. Max size: 2MB</small>
                        </div>
                    </div>
                    <div class="mb-3 row">
